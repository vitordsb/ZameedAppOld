import "./chunk-N2D6QO5L.js";
import {
  CasingCache,
  SelectionProxyHandler,
  TypedQueryBuilder
} from "./chunk-CPOLWR3O.js";
import {
  Column,
  Columns,
  DrizzleError,
...
var _a4, _b2;
var PgViewBase = class extends (_b2 = View, _a4 = entityKind, _b2) {
};
__publicField(PgViewBase, _a4, "PgViewBase");
...
var PgDialect = class {
  ...
  buildUpdateSet(table, set) {
    ...
    const columnNames = Object.keys(tableColumns).filter(
      (colName) => {
        var _a38;
        return set[colName] !== void 0 || ((_a38 = tableColumns[colName]) == null ? void 0 : _a38.onUpdateFn) !== void 0;
      }
    );
      ...
      if (config.columns) {
        ...
        if (selectedColumns.length > 0) {
          selectedColumns = isIncludeMode ? selectedColumns.filter((c) => {
            var _a38;
            return ((_a38 = config.columns) == null ? void 0 : _a38[c]) === true;
          }) : Object.keys(tableConfig.columns).filter((key) => !selectedColumns.includes(key));
        }
      } else {
        selectedColumns = Object.keys(tableConfig.columns);
...
__publicField(PgDialect, _a5, "PgDialect");
...
__publicField(PgSelectBuilder, _a6, "PgSelectBuilder");
var _a7, _b3;
var PgSelectQueryBuilderBase = class extends (_b3 = TypedQueryBuilder, _a7 = entityKind, _b3) {
  ...
  createJoin(joinType) {
    return (table, on) => {
      ...
      if (typeof tableName === "string" && ((_a38 = this.config.joins) == null ? void 0 : _a38.some((join) => join.alias === tableName))) {
...
__publicField(PgSelectQueryBuilderBase, _a7, "PgSelectQueryBuilder");
var _a8, _b4;
var PgSelectBase = class extends (_b4 = PgSelectQueryBuilderBase, _a8 = entityKind, _b4) {
  constructor() {
    super(...arguments);
    __publicField(this, "authToken");
    __publicField(this, "execute", (placeholderValues) => {
...
__publicField(PgSelectBase, _a8, "PgSelect");
...
__publicField(QueryBuilder, _a9, "PgQueryBuilder");
...
__publicField(PgInsertBuilder, _a10, "PgInsertBuilder");
var _a11, _b5;
var PgInsertBase = class extends (_b5 = QueryPromise, _a11 = entityKind, _b5) {
...
__publicField(PgInsertBase, _a11, "PgInsert");

// node_modules/drizzle-orm/pg-core/query-builders/refresh-materialized-view.js
var _a12, _b6;
var PgRefreshMaterializedView = class extends (_b6 = QueryPromise, _a12 = entityKind, _b6) {
...
__publicField(PgRefreshMaterializedView, _a12, "PgRefreshMaterializedView");
...
__publicField(PgUpdateBuilder, _a13, "PgUpdateBuilder");
var _a14, _b7;
var PgUpdateBase = class extends (_b7 = QueryPromise, _a14 = entityKind, _b7) {
...
__publicField(PgUpdateBase, _a14, "PgUpdate");

// node_modules/drizzle-orm/pg-core/query-builders/count.js
var _a15, _b8, _c;
var _PgCountBuilder = class _PgCountBuilder extends (_c = SQL, _b8 = entityKind, _a15 = Symbol.toStringTag, _c) {
  constructor(params) {
    super(_PgCountBuilder.buildEmbeddedCount(params.source, params.filters).queryChunks);
    __publicField(this, "sql");
    __publicField(this, "token");
    __publicField(this, _a15, "PgCountBuilder");
    __publicField(this, "session");
    this.params = params;
    this.mapWith(Number);
...
__publicField(RelationalQueryBuilder, _a16, "PgRelationalQueryBuilder");
var _a17, _b9;
var PgRelationalQuery = class extends (_b9 = QueryPromise, _a17 = entityKind, _b9) {
...
__publicField(PgRelationalQuery, _a17, "PgRelationalQuery");

// node_modules/drizzle-orm/pg-core/query-builders/raw.js
var _a18, _b10;
var PgRaw = class extends (_b10 = QueryPromise, _a18 = entityKind, _b10) {
...
__publicField(PgRaw, _a18, "PgRaw");
...
__publicField(PgDatabase, _a19, "PgDatabase");
...
__publicField(IndexBuilderOn, _a20, "PgIndexBuilderOn");
var _a21;
_a21 = entityKind;
...
__publicField(IndexBuilder, _a21, "PgIndexBuilder");
var _a22;
_a22 = entityKind;
var Index = class {
...
__publicField(Index, _a22, "PgIndex");
function index(name) {
...
__publicField(PgPolicy, _a23, "PgPolicy");
...
__publicField(PgRole, _a24, "PgRole");
...
__publicField(PgSequence, _a25, "PgSequence");
...
__publicField(DefaultViewBuilderCore, _a26, "PgDefaultViewBuilderCore");
var _a27, _b11;
var ViewBuilder = class extends (_b11 = DefaultViewBuilderCore, _a27 = entityKind, _b11) {
  as(qb) {
    if (typeof qb === "function") {
...
__publicField(ViewBuilder, _a27, "PgViewBuilder");
var _a28, _b12;
var ManualViewBuilder = class extends (_b12 = DefaultViewBuilderCore, _a28 = entityKind, _b12) {
...
__publicField(ManualViewBuilder, _a28, "PgManualViewBuilder");
var _a29;
_a29 = entityKind;
...
__publicField(MaterializedViewBuilderCore, _a29, "PgMaterializedViewBuilderCore");
var _a30, _b13;
var MaterializedViewBuilder = class extends (_b13 = MaterializedViewBuilderCore, _a30 = entityKind, _b13) {
  as(qb) {
    if (typeof qb === "function") {
      qb = qb(new QueryBuilder());
    }
...
__publicField(MaterializedViewBuilder, _a30, "PgMaterializedViewBuilder");
var _a31, _b14;
var ManualMaterializedViewBuilder = class extends (_b14 = MaterializedViewBuilderCore, _a31 = entityKind, _b14) {
  constructor(name, columns, schema) {
    super(name, schema);
    __publicField(this, "columns");
    this.columns = getTableColumns(pgTable(name, columns));
...
__publicField(ManualMaterializedViewBuilder, _a31, "PgManualMaterializedViewBuilder");
var _a32, _b15, _c2;
var PgView = class extends (_c2 = PgViewBase, _b15 = entityKind, _a32 = PgViewConfig, _c2) {
  constructor({ pgConfig, config }) {
    super(config);
    __publicField(this, _a32);
    if (pgConfig) {
      this[PgViewConfig] = {
        with: pgConfig.with
      };
...
var _a33, _b16, _c3;
var PgMaterializedView = class extends (_c3 = PgViewBase, _b16 = entityKind, _a33 = PgMaterializedViewConfig, _c3) {
  constructor({ pgConfig, config }) {
    super(config);
    __publicField(this, _a33);
...
__publicField(PgSchema, _a34, "PgSchema");
...
__publicField(PgPreparedQuery, _a35, "PgPreparedQuery");
var _a36;
_a36 = entityKind;
var PgSession = class {
  constructor(dialect) {
...
__publicField(PgSession, _a36, "PgSession");
var _a37, _b17;
var PgTransaction = class extends (_b17 = PgDatabase, _a37 = entityKind, _b17) {
...
__publicField(PgTransaction, _a37, "PgTransaction");
